...
class BehaviorDataFrame:
    def __init__(self, experiment=0, data_type='fmri'):
...
def get_all_subjects_concatenated_dataframe(data_type='fmri'):
    """
    ...
    for subject_id in active_subjects:
        behavior_df = BehaviorDataFrame(experiment=0, data_type=data_type)
    ...
    # save as csv
    all_subjects_df.to_csv("all_subjects_behavior_data_" + data_type + ".csv", index=False)
...
if __name__ == "__main__":
    ...
    get_all_subjects_concatenated_dataframe()
