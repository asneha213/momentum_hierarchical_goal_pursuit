...
if __name__ == "__main__":
    ...
    if mode == "SH":
        if condition == "extreme":
            aprobs = {"M": 0.8, "C": 0.2, "S": 0.2, "G": 0.8}

        else:
            aprobs = {"M": 0.6, "C": 0.4, "S": 0.4, "G": 0.6}

    # P Higher Others Lower
    # HO, SH
    if mode == "BR":
        if condition == "extreme":
            aprobs = {"M": 0.1, "C": 0.7, "S": 0.8, "G": 0.8}
        else:
            aprobs = {"M": 0.3, "C": 0.6, "S": 0.6, "G": 0.6}

    # B Higher Others Lower
    # BR, HO
    if mode == "HO":
        if condition == "extreme":
            aprobs = {"M": 0.8, "C": 0.8, "S": 0.8, "G": 0.1}

        else:
            aprobs = {"M": 0.6, "C": 0.6, "S": 0.6, "G": 0.3}
