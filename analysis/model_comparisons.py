...
class ModelComparisons:
    ...
    def plot_all_models_comparison(self, ax=None, likelihood_type='total'):
        """
        Compare all 6 models using total likelihoods and display both AIC and BIC scores.
    ...
    def plot_comprehensive_model_comparison(self):
        """
        Create a comprehensive comparison plot showing all 6 models using total likelihood only.
...
if __name__ == "__main__":
    ...
    # Compare all 6 models across different likelihood types
