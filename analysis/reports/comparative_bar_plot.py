...
def plot_comparative_bar_plot(ax, data, mean_values, std_dev_values, \
                              ...
                              label_font=16, tick_font=12, \
                            legend_font=14, title_font=14):
        ...
        if draw_data:
            for k in range(len(data[i])):
                ax.plot(pos + np.random.normal(0, 0.01, len(pos)) , \
                        ...
                        color=colors[i], marker='o', linestyle='None', markersize=1)
    ...
    ax.annotate(title, xy=(0.5, 1.05), xycoords='axes fraction',
                    fontsize=title_font, ha='center', fontweight='bold')
