...
def draw_significant_bar_plots(ax, data_points, model_names, \
    ...
    print("Colors received in plotting function:", colors)
    print("Number of colors:", len(colors), "Number of bars:", len(model_names))

    bars = ax.barh(model_names, fit_values,  color=colors, edgecolor='#000000', linewidth=2, alpha=0.6, height=0.5)
    ...
    # Make y-axis labels (model names) bold
    ...
    def add_significance_marker(ax: object, bar1: object, bar2: object, text: object, x_offset: object = 0.54, bar_height: object = 0.2) -> object:
        if text == 'ns':
            return
    ...
    print("Significance markers:", sig_strs)
